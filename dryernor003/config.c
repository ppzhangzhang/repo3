...
void ConfigInit(void)
{
	...
	//dryer
	theConfig.prodmod = iniparser_getint(cfgIni, "dryer:prodmod", 0);
	theConfig.prodtestWiFi = iniparser_getint(cfgIni, "dryer:prodtestWiFi", 0);
	theConfig.prodtestSum = iniparser_getint(cfgIni, "dryer:prodtestSum", 0);
	theConfig.prodexitSum = iniparser_getint(cfgIni, "dryer:prodexitSum", 0);

	
	strncpy(theConfig.sw, iniparser_getstring(cfgIni, "dryer:sw", "1.0"), sizeof (theConfig.sw) - 1);//software version
	theConfig.nEthEnable = iniparser_getint(cfgIni, "dryer:nEthEnable", 1);
	theConfig.nWifiEnable = iniparser_getint(cfgIni, "dryer:nWifiEnable", 1);
	theConfig.screenLog = iniparser_getboolean(cfgIni, "dryer:screenLog", 0);
    // network
...
static void ConfigSavePublic(void)
{
	...
	//dryer
	iniparser_set(cfgIni, "dryer:screenLog", theConfig.screenLog ? "y" : "n");
	sprintf(buf, "%d", theConfig.prodmod);
	iniparser_set(cfgIni, "dryer:prodmod", buf);
	//sprintf(buf, "%d", theConfig.langselect);
	//iniparser_set(cfgIni, "washer:langselect", buf);
	sprintf(buf, "%d", theConfig.prodtestWiFi);
	iniparser_set(cfgIni, "dryer:prodtestWiFi", buf);
	sprintf(buf, "%d", theConfig.prodtestSum);
	iniparser_set(cfgIni, "dryer:prodtestSum", buf);
	sprintf(buf, "%d", theConfig.prodexitSum);
	iniparser_set(cfgIni, "dryer:prodexitSum", buf);
	sprintf(buf, "%d", theConfig.nEthEnable);
	iniparser_set(cfgIni, "dryer:nEthEnable", buf);
	sprintf(buf, "%d", theConfig.nWifiEnable);
	iniparser_set(cfgIni, "dryer:nWifiEnable", buf);
    // network
